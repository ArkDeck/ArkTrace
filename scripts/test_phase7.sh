...
testProcessCounterDensityQualityScopeSurvivesTheMachineContract
testProcessMeasureStorageAndTimeAreQualityProbedAtOpen
testCounterQualityIsAttributedToItsPhysicalSampleTable
testCounterSeriesDirectoryFindsSeriesASamplePageWouldMiss
testEveryCounterSeriesGetsALaneRegardlessOfSampleVolume
