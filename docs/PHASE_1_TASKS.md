...
- **P1-T08：Mandatory gate。** `scripts/test_phase1.sh` fail closed 校验 binary/manifest/arm64、fixture/license SHA/byte count/Git blob，clean build 后运行真实 locked scheduling fixture；review hardening 后实测 94 tests、0 failed、0 skipped，并输出 4 KiB 内 machine evidence。
