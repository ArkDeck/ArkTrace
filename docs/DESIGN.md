...
7. ~~indexed viewport query 在 large trace 上满足规格目标~~——已关闭（2026-08-15，P3-T09/P4-T06）：20-sample evidence 的 cache/viewport/context/analysis p95 分别为 321.754/283.091/1165.668/1088.449 ms，frame p95 4.068 ms，peak RSS 811,909,120 bytes；24 个 applicable/persistent indexes 精确闭合、`usesAutomaticIndex=false`，证据见 `Fixtures/release-evidence/phase3-large-performance.json`；
