...
final class TraceEventModelContractTests: XCTestCase {
    ...
    func testThreadStateCodableGoldenPreservesRawAndNormalizedState() throws {
        ...
        try assertGolden(
            [known, unknown],
            #"[{"cpu":3,"isOpenEnded":false,"key":{"rowID":1,"table":"thread_state"},"normalizedState":"runnable","pid":11,"range":{"endNs":2,"startNs":1},"state":"R+","threadKey":{"itid":9},"tid":10},{"cpu":null,"isOpenEnded":true,"key":{"rowID":2,"table":"thread_state"},"normalizedState":null,"pid":null,"range":{"endNs":4,"startNs":2},"state":"vendor-state","threadKey":{"itid":12},"tid":null}]"#
        )
    }
    ...
    func testTraceSliceCodableGoldenLocksParentAndAsyncFields() throws {
        ...
        try assertGolden(
            [populated, nullable],
            #"[{"category":"io","depth":6,"isAsync":true,"isOpenEnded":false,"key":{"rowID":4,"table":"callstack"},"name":"slice","parentEventKey":{"rowID":1,"table":"callstack"},"processKey":{"ipid":3},"range":{"endNs":9,"startNs":5},"threadKey":{"itid":2}},{"category":null,"depth":null,"isAsync":false,"isOpenEnded":false,"key":{"rowID":5,"table":"callstack"},"name":"instant","parentEventKey":null,"processKey":null,"range":{"endNs":9,"startNs":9},"threadKey":null}]"#
        )
    }
    ...
    func testCounterCodableGoldenLocksScopeUnitAndOptionalDuration() throws {
        ...
        try assertGolden(
            [cpu, process],
            #"[{"cpu":1,"filterID":20,"name":"cycles","processKey":null,"samples":[{"durationNs":5,"key":{"rowID":7,"table":"measure"},"timestampNs":100,"value":42}],"scope":"cpu","unit":"count"},{"cpu":null,"filterID":21,"name":"rss","processKey":{"ipid":8},"samples":[{"durationNs":null,"key":{"rowID":9,"table":"measure"},"timestampNs":200,"value":64}],"scope":"process","unit":null}]"#
        )
    }
